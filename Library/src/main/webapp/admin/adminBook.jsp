    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="background-image: url('${pageContext.request.contextPath}/static/images/bg_1.jpg');height: 700px;margin-top: -20px;background-size:cover">
            ...
            <table class="table table-striped table-hover ">
                ...
                <c:forEach items="${requestScope.p.list}" begin="0" end="${requestScope.p.pageSize-1}" var="i" varStatus="Status">
                    <tr>
                        <td>${i.name}</td>
                        <td>${i.author}</td>
                        <td>${i.publish}</td>
                        ...
                        <td><a href="${pageContext.request.contextPath}/AdminCenterServlet?method=bookDel&delId=${requestScope.p.list[Status.index].id}"><button class="btn btn-primary btn-xs" name="button3" value="${Status.index}">删除</button></a></td>
                    </tr>
                </c:forEach>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table table-striped table-hover">
                                    <tr>
                                        <td>书名</td>
                                        <td>${requestScope.p.list[Status.index].name}</td>
                                    </tr>
                                    <tr>
                                        <td>价格</td>
                                        <td>${requestScope.p.list[Status.index].price}</td>
                                    </tr>
                                    <tr>
                                        <td>作者</td>
                                        <td>${requestScope.p.list[Status.index].author}</td>
                                    </tr>
                                    <tr>
                                        <td>出版社</td>
                                        <td>${requestScope.p.list[Status.index].publish}</td>
                                    </tr>
                                    <tr>
                                        <td>日期</td>
                                        <td>${requestScope.p.list[Status.index].date}</td>
                                    </tr>
                                    <tr>
                                        <td>语言</td>
                                        <td>${requestScope.p.list[Status.index].language}</td>
                                    </tr>
                                    <tr>
                                        <td>ISBN</td>
                                        <td>${requestScope.p.list[Status.index].ISBN}</td>
                                    </tr>
                                    <tr>
                                        <td>类型</td>
                                        <td>${requestScope.p.list[Status.index].type}</td>
                                    </tr>
                                    <tr>
                                        <td>数量</td>
                                        <td>${requestScope.p.list[Status.index].num}</td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="${pageContext.request.contextPath}/AdminCenterServlet?method=bookUpdate" method="post">
                                <div class="modal-body">
                                    <input type="hidden" value="${requestScope.p.list[Status.index].id}" name="update1">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            <td>书名</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].name}" name="text0"></td>
                                        </tr>
                                        <tr>
                                            <td>价格</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].price}"name="text1"></td>
                                        </tr>
                                        <tr>
                                            <td>作者</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].author}" name="text2"></td>
                                        </tr>
                                        <tr>
                                            <td>出版社</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].publish}"name="text3"></td>
                                        </tr>
                                        <tr>
                                            <td>日期</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].date}"name="text4"></td>
                                        </tr>
                                        <tr>
                                            <td>语言</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].language}"name="text5"></td>
                                        </tr>
                                        <tr>
                                            <td>ISBN</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].ISBN}"name="text6"></td>
                                        </tr>
                                        <tr>
                                            <td>类型</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].type}"name="text7"></td>
                                        </tr>
                                        <tr>
                                            <td>数量</td>
                                            <td><input type="text" value="${requestScope.p.list[Status.index].num}"name="text8"></td>
                                        </tr>
            ...
            <nav aria-label="Page navigation" style="text-align: center">
                <ul class="pagination" >
                    ...
                    <c:forEach var="i" begin="1" end="${requestScope.p.totalPage}" varStatus="currentPage">
